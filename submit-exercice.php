                ...
                <div class="container-bloc">
                    ...
                    <div class="bloc2">
                        ...
                        <div class="holder tag-container">
                            <input name="exercise-chapitre" class="holder tag-container" id="keyword"/>
                        </div>
...
<script>
    ...
    document.getElementById('continue-btn').addEventListener('click', function() {
        ...
        let exerciseChapitre = document.getElementById('exercise-chapitre').value.trim();
        let keyword = document.getElementById('keyword').value.trim();
        let exerciseDifficulty = document.getElementById('exercise-difficulty').value.trim();
        let exerciseDuration = document.getElementById('exercise-duration').value.trim(); 
        ...
        submitExerciseData.generalInfo = {
            ...
            "exerciseChapitre": exerciseChapitre,
            "keyword": keyword,
